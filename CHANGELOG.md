...
- Package **0.4.1** keeps Kibana `^9.2.0`. Asset: [`integration/assets/0.4.1/chargeback-0.4.1.zip`](integration/assets/0.4.1/chargeback-0.4.1.zip). Source: [elastic/integrations#20591](https://github.com/elastic/integrations/pull/20591).
- Refresh Billing Components Overview, Usage and Cost Allocation, and Configuration dashboard screenshots in the repo README and `integration/README.md`.
